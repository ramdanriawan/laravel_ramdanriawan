...
var data = [
        ...
        $.plot($("#flot-bar-chart"), data, {
            ...
            xaxis: {
                tickLength: 0,
                ticks: [
                    [0, "ContaboInstance One"],
                    [1, "ContaboInstance Two"],
                    [2, "ContaboInstance Three"],
                    [3, "ContaboInstance Four"],
                    [4, "ContaboInstance Five"],
                    [5, "ContaboInstance Six"],
                    [6, "ContaboInstance Seven"]]
            },
            yaxis: {
                min: 0
            },
