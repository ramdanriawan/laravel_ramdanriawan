...
<div class="container" style="text-align: center; width: 520px; margin-top: 40px;">
...
{{--                       name="namaLengkap" value="{{ old('namaLengkap') }}" placeholder="Nama Lengkap" required>--}}
{{--                @error('username')--}}
...
{{--                       name="tglLahir" value="{{ old('tglLahir') }}" placeholder="Tgl Lahir" required>--}}
{{--                @error('tglLahir')--}}
{{--                <div class="invalid-feedback">--}}
{{--                    {{ $message }}--}}
{{--                </div>--}}
...
{{--            </div>--}}
            ...
            <div class="form-group">
                <input type="text" class="form-control @error('namaTenagaKesehatan') is-invalid @enderror" id="namaTenagaKesehatan"
                       name="namaTenagaKesehatan" value="{{ old('namaTenagaKesehatan') }}" placeholder="Nama Tenaga Kesehatan" required>
                @error('namaTenagaKesehatan')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
                @enderror
            ...
            <div class="form-group">
                <input type="text" class="form-control @error('namaTempatPraktikPuskesmasKlinik') is-invalid @enderror" id="namaTempatPraktikPuskesmasKlinik"
                       name="namaTempatPraktikPuskesmasKlinik" value="{{ old('namaTempatPraktikPuskesmasKlinik') }}" placeholder="Nama Tempat Praktik / Puskesmas / Klinik" required>
                @error('namaTempatPraktikPuskesmasKlinik')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
                @enderror
            ...
            <div class="form-group">
                <input type="text" class="form-control @error('emailUsername') is-invalid @enderror" id="emailUsername"
                       name="emailUsername" value="{{ old('emailUsername') }}" placeholder="Email / Username" required>
                @error('emailUsername')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="form-group">
                <input type="password" class="form-control @error('password_confirmation') is-invalid @enderror" id="password_confirmation"
                       name="password_confirmation" value="{{ old('password_confirmation') }}" placeholder="Ulangi Password" required>
