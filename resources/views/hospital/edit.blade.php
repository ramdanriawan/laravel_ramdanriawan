    ...
    <div class="row">
        <div class="col-xs-6 col-md-6 col-lg-6">
            <div class="panel panel-default">
                ...
                <!-- Tab panes -->
                    <form method="post" action="{{ url(route('hospital.update', ['hospital' => $data->id])) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="hospitalName" name="hospitalName"
                                   value="{{ old('hospitalName') == '' ? $data->hospitalName : old('hospitalName') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder="phone" name="phone"
                                   value="{{ old('phone') == '' ? $data->phone : old('phone') }}" required minlength="9">
