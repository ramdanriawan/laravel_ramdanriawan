            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a href="{{ url(route('patient.create')) }}" class="btn btn-primary"
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade padding in active" id="Active">
                            <table class="table " id="dataTables-active-account">
                                ...
                                <tr>
                                    <th width="auto">ID</th>
                                    <th width="auto">HospitalName</th>
                                    <th width="auto">PatientName</th>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            let datatable1 = $('#dataTables-active-account').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ url(route('api.v1.web.patient.dataTable')) }}',
                pageLength: 5,
